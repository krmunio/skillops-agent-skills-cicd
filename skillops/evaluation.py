...
# Benchmark inputs retain their repository-relative paths and historical hashes.
...
FINGERPRINT_FILES = (
    ...
    "eval/skill-guide-rubric.json", "skillops/skill_guide.py",
    "skillops/evaluation.py", "skillops/copilot_runtime.py", "skillops/skillops.py",
    "skillops/candidates.py", "skillops/repositories.py",
