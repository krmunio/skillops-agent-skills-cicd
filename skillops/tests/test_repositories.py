...
class RepositoryTests(unittest.TestCase):
    ...
    def test_offline_commands_never_construct_copilot(self):
        for args, expected in (
            ...
            with patch.object(skillops, "__file__", str(self.root / "skillops/skillops.py")), patch(
    ...
    def test_cross_repository_and_source_or_evaluator_drift_block(self):
        ...
        for path in (self.target / "issues.py", self.root / "eval/rubric.json", self.root / "skillops/evaluation.py"):
            before = path.read_bytes()
